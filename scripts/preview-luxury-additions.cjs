...
const products=require('../data/luxury-additions.json').products;
const root=path.resolve(__dirname,'..'),out=path.join(root,'artifacts/luxury-additions');
(async()=>{
 ...
 console.log('Saved 20-design contact sheets to artifacts/luxury-additions.');
